const consentTextConfig = {
  ...
  '66aca69be884d495377c3f30': {
    ...
    consentText: `
      ...
      <p>
        La siguiente tarea es parte del proyecto de investigación descrito anteriormente. Al acceder a la aplicación web, se le presentará la tarea de escribir un mensaje persuasivo para el Fondo Mundial para la Naturaleza (WWF) utilizando un editor de texto con tecnología de IA. Después de la tarea, se le pedirá que complete un pequeño cuestionario relacionado con su experiencia con el editor.
      </p>
      <p>
